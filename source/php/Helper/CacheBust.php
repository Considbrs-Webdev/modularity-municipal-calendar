...
class CacheBust
{
     ...
     *
     * @param string $name The original filename (e.g., 'css/modularity-municipal-calendar.css')
    ...
    private static function getManifest(): ?array
    {
        ...
        $manifestPath = MODULARITYMUNICIPALCALENDAR_PATH . 'assets/dist/manifest.json';
